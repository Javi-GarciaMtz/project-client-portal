export const sidebarItems = [
    { label: 'Crear solicitud', icon: 'edit_document', url: './request/create', permissions: ['admin', 'user'] },
    ...
    { label: 'Mis solicitudes', icon: 'list_alt', url: './users/my-requests', permissions: ['user'] },
];